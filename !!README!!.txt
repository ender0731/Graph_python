Graphing function/package is used to automate the generation of quick plots of all the variables in a dataset. This can be done manually through the command prompt or through the simple automated batch file, the steps for which have been outlined below:-
